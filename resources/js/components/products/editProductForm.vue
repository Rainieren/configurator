<template>
    <div class="">
        <div class="px-10 py-5 xl:px-20 xl:py-10">
            <div class="flex">
            ...
            <div class="flex flex-column xl:flex-row xl:space-x-10">
                <div class="w-100 xl:w-8/12">
                    <form :action="'/dashboard/product/' + product.id + '/update'" method="POST" class="w-full my-2" id="productEditForm" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-column xl:flex-row xl:space-x-5">
                            <div class="w-100 xl:w-4/12 mb-3 xl:m-0">
                                <p class="text-gray-800 font-medium text-sm md:text-base xl:text-lg">Product attributes</p>
                        ...
                        <div class="flex flex-column xl:flex-row xl:space-x-5">
                            ...
                            <div class="w-100 xl:w-8/12 mb-3 xl:m-0">
                                <div class="relative">
    ...
    data () {
        return {
            fields: {
                ...
                priceIncrease: this.product.percentage_increase * 100,
