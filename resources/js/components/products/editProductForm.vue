        ...
        <div class="px-20 pt-10 pb-10">
            <div class="flex">
                <div class="w-1/2 flex items-center">
                    <p class="text-3xl font-bold text-indigo-900">{{  this.fields.name }}</p>
                </div>
            </div>
        </div>
        <div class="px-20">
                ...
                <div class="w-6/12">
                    <form action="" method="POST" class="w-full my-2" id="productCreateForm" enctype="multipart/form-data">
                        ...
                        <div class="flex space-x-5">
                            ...
                            <div class="w-8/12">
                                <input v-model="fields.name"  name="name" id="name" type="text" :class="{ 'border-red-500' : submitted && $v.name.$error}" class="p-2 border border-gray-500 rounded-md w-100 shadow-sm" >
                                ...
                                <fieldset>
                                    <div class="flex items-start">
                                        <div class="flex items-center h-5">
                                            <input v-model="fields.isConfigurableProduct" v-on:click="isConfigurableProductFunc()" :checked="fields.isConfigurableProduct" id="configurable_product" name="configurable_product" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                        </div>
                        ...
                        <div class="flex space-x-5 my-5" v-if="fields.isConfigurableProduct">
                            <div class="w-4/12">
                                <p class="text-gray-800 font-medium text-lg">Configurator</p>
                            </div>
                            <div class="w-8/12">
                                <select v-model="fields.configurator_id" type="text" name="configurator_id" id="configurator_id" class="p-2 border border-gray-500 rounded-md w-100 shadow-sm">
                            ...
                            <div class="w-8/12">
                                <div class="relative rounded-md shadow-sm">
                                  ...
                                  <span class="text-gray-500 sm:text-sm">
                                    ...
                                    <input v-model="fields.price" :maxlength="8" v-mask="mask" :class="{ 'border-red-500' : submitted && $v.price.$error}" type="text" name="price" id="price" class="block w-full pl-8 pr-2 py-2 border border-gray-300 rounded-md" placeholder="0.00" :disabled="fields.hasPriceIncrease">
                                </div>
                        ...
                        <div class="flex space-x-5">
                            ...
                            <div class="w-8/12">
                                <input v-model="fields.sku" type="text" id="sku" name="sku"  :class="{ 'border-red-500' : submitted && $v.sku.$error}" class="p-2 border border-gray-500 rounded-md w-100 shadow-sm">
                        ...
                        <div class="flex space-x-5">
                            ...
                            <div class="w-8/12">
                                <input v-model="fields.stock" :maxlength="9" v-on:keypress="isLetter($event)" type="text" id="stock" name="stock" :class="{ 'border-red-500' : submitted && $v.stock.$error}" class="p-2 border border-gray-500 rounded-md w-100 shadow-sm">
