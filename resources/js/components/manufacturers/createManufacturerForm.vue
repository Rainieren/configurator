        ...
        <div class="w-6/12">
            <form action="/dashboard/manufacturer/store" method="POST" class="w-full my-2" id="manufacturerCreateForm">
                ...
                <div class="flex float-right my-5 space-x-5">
                    ...
                    <button @click.prevent="submitForm" type="submit" class="bg-blue-500 rounded p-2 w-48 text-center text-white hover:no-underline hover:bg-blue-700 transition shadow-sm">Create manufacturer</button>
                </div>
            </form>
        </div>
    </div>
...
export default {
    ...
    methods: {
        getAllCountries: function() {
            axios.get('/api/get/all/countries')
                .then(response => {
        ...
        submitForm: function() {
            ...
            if(this.$v.$error) {
                ...
                document.getElementById("manufacturerCreateForm").submit();
            }
        },
    },
    validations: {
