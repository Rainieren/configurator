...
<head>
    ...
    <body class="antialiased bg-white">
        <div class="w-80 bg-white h-screen p-3 border-r border-gray-300 fixed shadow-sm">
            ...
            <div class="my-4 relative">
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input type="text" name="price" id="price" class="block w-full pl-12 pr-8 py-2 border sm:text-sm border-gray-200 rounded-md" placeholder="Search...">
                </div>
            </div>

            <ul class="space-y-2">
                <li>
                    <a href="{{ route('home') }}" class="px-3 py-2 rounded transition flex font-medium items-center hover:no-underline {{ Route::currentRouteNamed('home') ? 'bg-gray-200 font-normal text-indigo-600 hover:text-indigo-800' : '' }}">
                ...
                <li>
                    <a href="{{ route('configurator') }}" class="hover:bg-gray-200 px-3 py-2 rounded transition flex font-medium items-center hover:text-indigo-600 hover:no-underline {{ Route::currentRouteNamed('configurator') ? 'bg-gray-200 text-indigo-600 hover:text-indigo-800' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ route('logout') }}" class="hover:bg-gray-200 px-3 py-2 rounded transition flex font-medium items-center hover:text-indigo-600 hover:no-underline" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
