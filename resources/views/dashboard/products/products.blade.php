    ...
    <div class="border-b px-5 py-3 bg-white">
        <div class="flex">
            ...
            <div class="w-1/2 text-right">
                <a href="{{ route('createProduct') }}" class="bg-indigo-600 py-2 px-4 text-white shadow-sm rounded">Nieuw product</a>
            </div>
        </div>
    </div>
    <div class="p-5">
                                ...
                                @foreach($products as $product)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <div class="p m-0 text-gray-400">{{ substr($product->description, 0, 24) }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                           {{ $product->stock }}
                                        </td>
