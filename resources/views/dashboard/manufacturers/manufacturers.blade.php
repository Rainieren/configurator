    ...
    <div class="px-10 py-5 md:px-20 md:py-10 transition-all">
        <div class="flex">
            <div class="w-1/2 flex items-center">
                <p class="text-base md:text-lg lg:text-2xl xl:text-3xl font-extrabold text-gray-900">Manufacturers</p>
            </div>
            <div class="w-1/2 text-right">
                <a href="{{ route('createManufacturer') }}" type="button" class="appearance-none inline-flex justify-center rounded-md border border-indigo-300 shadow-sm p-1 lg:px-4 lg:py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 hover:no-underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
